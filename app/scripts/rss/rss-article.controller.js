(function() {
	...
	rssArticleController.$inject = [
		'$stateParams', '$ionicActionSheet', '$cordovaSocialSharing', 'rssService'];

	/* @ngInject */
	function rssArticleController($stateParams, $ionicActionSheet, $cordovaSocialSharing, rssService) {
		...
		function loadArticle() {
			rssService.getArticle(articleId)
